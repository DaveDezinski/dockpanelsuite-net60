...
namespace WeifenLuo.WinFormsUI.Docking
{
    ...
    internal class VS2005MultithreadingDockPaneStrip : DockPaneStripBase
    {
        ...
        private readonly Bitmap _imageButtonWindowList;
        private readonly Bitmap _imageButtonWindowListOverflow;
        ...
        private InertButton ButtonClose
        {
            get
            {
                ...
                {
                    _buttonClose = new InertButton(_imageButtonClose, _imageButtonClose);
        ...
        private InertButton ButtonWindowList
        {
            get
            {
                ...
                {
                    _buttonWindowList = new InertButton(_imageButtonWindowList, _imageButtonWindowListOverflow);
        ...
        private static string ToolTipClose
        {
            get
            {
                _toolTipClose ??= ThemeVS2005.Strings.DockPaneStrip_ToolTipClose;
        ...
        private static string ToolTipSelect
        {
            get
            {
                _toolTipSelect ??= ThemeVS2005.Strings.DockPaneStrip_ToolTipWindowList;
            ...
            : base(pane)
        {
            ...
            lock (lockObj)
            {
                ...
                _imageButtonWindowList = (Bitmap)Resources.DockPane_Option.Clone();
                _imageButtonWindowListOverflow = (Bitmap)Resources.DockPane_OptionOverflow.Clone();
            }
        ...
        protected override void Dispose(bool disposing)
        {
            if (disposing)
            {
                ...
                _imageButtonWindowList.Dispose();
                _imageButtonWindowListOverflow.Dispose();
            }
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            if (Appearance == DockPane.AppearanceStyle.Document && DockPane.ActiveContent != null &&
                EnsureDocumentTabVisible(DockPane.ActiveContent, false))
            {
                CalculateTabs();
            }
