...
namespace WeifenLuo.WinFormsUI.ThemeVS2013
{
    ...
    {
        private sealed class TabVS2013 : Tab
        {
        ...
        private void CalculateTabs_ToolWindow()
        {
            ...
            {
                var tab = tabObject as TabVS2013;
        ...
        private void CalculateTabs_Document()
        {
            ...
            {
                int tempX = x;
                var tab = Tabs[_startDisplayingTab] as TabVS2013;
        ...
        private void DrawTab_ToolWindow(Graphics g, TabVS2013 tab)
        {
            ...
            Rectangle rectIcon = new(rect.X + ToolWindowImageGapLeft, rect.Y + rect.Height - ToolWindowImageGapBottom - ToolWindowImageHeight, ToolWindowImageWidth, ToolWindowImageHeight);
